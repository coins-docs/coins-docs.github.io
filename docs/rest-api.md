...
Name         | Type   | Mandatory | Description
-------------|--------|-----------| ------------
internalOrderId | STRING | yes       | Client side ID assigned to the funds withdrawal order, It is recommended to use uuid. One ID can only successfully create one order, Length is 10 to 60
currency     | STRING | Yes       | The parameter represents the currency used in the transaction and should be set to PHP as it is the only currency currently supported.
...
FieldName            | Type   | Description
----------------|--------| ------------
externalOrderId | String   | The client side id.
...
Name            | Type   | Mandatory | Description
----------------|--------|-----------| ------------
internalOrderId | STRING | NO        | Query for Coins side ID, Two required one.
externalOrderId | STRING | NO        | Query for Client side ID, Two required one.
...
FieldName            | Type    | Description
----------------|---------| ------------
externalOrderId | String  | Client side ID.
internalOrderId | String  |The unique order id generated by the server.
